    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_date', models.DateTimeField(auto_now_add=True, verbose_name='Time of creation')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='Update time')),
                ('status', models.BooleanField(default=True, verbose_name='Status(active)')),
                ('role', models.CharField(choices=[('admin', 'Administrator'), ('user', 'Regular user')], max_length=50)),
